...
# Add the Heroku app hostname when it exists.
...
MIDDLEWARE = [
    ...
    # WhiteNoise allows static files to be served correctly in production.
...
# Production uses DATABASE_URL, which Heroku provides for PostgreSQL.
DATABASES = {
